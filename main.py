...
team_1 = ["Gilchrist", "Tendulkar", "Lara", "Kohli", "deVilliers", "Kallis", "Ponting", "Starc", "Warne", "Mulitaran", "McGrath"]
team_2 = ["Gayle", "Sharma", "Root", "deKock", "McCulum", "Dhoni", "Russel", "Bravo", "Yuzi", "Bumrah", "Malinga"]
...
def check_for_a_winner(score_1, score_2, balls_left, wickets):
    if (score_1 > score_2) and (balls_left == 0) or (wickets == 10):
        return ("Team 1 wins"), False
    elif (score_2 > score_1):
        return ("Team 2 wins"), False
    elif (balls_left == 0) or (wickets == 10) and (score_1 == score_2):
        return ("We have a tie!"), False

print("Welcome to Mohit's cricket game\n")
        ...
        for overs in range(0, 10):
            ...
            for ball in range(1, 7):
                ...
                if (what_happened == 5):
                    ...
                    if ((what_happened==1) or (what_happened ==3) or (ball ==6)):
                        on_strike_batsman, non_striker_batsman = non_striker_batsman, on_strike_batsman

                        if ((what_happened==1 or what_happened ==3) and ball==6):
                            on_strike_batsman, non_striker_batsman = non_striker_batsman, on_strike_batsman
